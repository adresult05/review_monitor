...
CLIENT_SHEET = "고객사설정"
CLIENT_HEADERS = ["고객사명", "활성여부", "구글_PlaceID", "카카오_장소ID", "네이버_플레이스ID"]
...
def add_client(client_ws, name, google_id="", kakao_id="", naver_id="", active=True):
...
def update_client(client_ws, original_name, name=None, google_id=None, kakao_id=None, naver_id=None, active=None):
